...
public class Analysis implements Runnable{
	...
	private final static String symptomfile = System.getProperty("user.home") + "\\Documents\\Ruscio\\OpenHAB\\OpenHAB\\symptom.txt"; //write only
